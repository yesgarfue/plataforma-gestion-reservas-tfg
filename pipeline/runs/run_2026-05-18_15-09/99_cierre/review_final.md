...
**ID de ejecucion**: `run_2026-05-18_15-09`
...
|---|---:|---:|---:|---|
| `/` | `True` | `True` | `200` | http://127.0.0.1:55314/ |
| `/barcos/` | `True` | `True` | `200` | http://127.0.0.1:55314/barcos/ |
| `/cesta/` | `True` | `True` | `200` | http://127.0.0.1:55314/cesta/ |
| `/accounts/registro/` | `True` | `True` | `200` | http://127.0.0.1:55314/accounts/registro/ |
| `/accounts/login/` | `True` | `True` | `200` | http://127.0.0.1:55314/accounts/login/ |

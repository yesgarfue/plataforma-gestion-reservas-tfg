...
timestamp: 2026-05-19T02:16:18+02:00
...
| RF-32 | El cliente puede consultar el estado de su reserva usando el código de seguimiento recibido por email, incluso sin estar registrado. | Alta |
...
| RF-35 | Existe un panel de administración propio de la aplicación para gestión de barcos, clientes y reservas. | Alta |
...
| RNF-07 | Idioma de Código | Los nombres de variables, clases, funciones y rutas están en inglés; comentarios y docstrings en español. | Alta |
| RNF-08 | Seguridad | Las contraseñas se almacenan usando el mecanismo estándar de Django, no en texto plano. CSRF está activo y se validan todos los formularios. | Alta |
| RNF-09 | Datos de Ejemplo | La aplicación arranca con datos precargados: mínimo 5 barcos, 2 puertos, 2 fabricantes, 2 categorías (incluyendo velero), 1 usuario administrador de prueba y 1 usuario cliente de prueba. | Alta |

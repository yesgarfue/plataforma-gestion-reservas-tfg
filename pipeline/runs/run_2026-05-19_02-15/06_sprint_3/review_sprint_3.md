...
timestamp: 2026-05-19T03:03:41+02:00
...
|---|---:|---:|---:|---|
| `/` | `True` | `True` | `200` | http://127.0.0.1:51715/ |
| `/barcos/` | `True` | `True` | `200` | http://127.0.0.1:51715/barcos/ |
| `/cesta/` | `True` | `True` | `200` | http://127.0.0.1:51715/cesta/ |
| `/accounts/registro/` | `True` | `True` | `200` | http://127.0.0.1:51715/accounts/registro/ |
| `/accounts/login/` | `True` | `True` | `200` | http://127.0.0.1:51715/accounts/login/ |
| `/reserva/paso1/` | `True` | `True` | `200` | http://127.0.0.1:51715/reserva/paso1/ |

...
- **Validacion final OK global**: `False`
- **Clasificacion validacion final**: `bloqueado_arranque`
...
- `03_arquitectura`: gate=`aceptado`, auto_retries=`0`, regeneraciones=`1`
- `03b_scaffold`: gate=`N/A`, auto_retries=`0`, regeneraciones=`0`
- `04_sprint_1`: gate=`N/A`, auto_retries=`1`, regeneraciones=`0`

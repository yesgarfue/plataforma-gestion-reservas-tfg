...
timestamp: 2026-05-15T11:01:14+02:00
...
| RF-26 | Se aplica una tasa de combustible de 50 € por día a los alquileres, excepto para barcos de categoría velero donde la tasa es 0 €. | Alta |
...
| RF-34 | Existe un panel de administración propio de la aplicación para la gestión de barcos, clientes y reservas. | Alta |
| RF-35 | El administrador puede realizar operaciones de alta, edición y baja de barcos desde el panel de administración. | Alta |

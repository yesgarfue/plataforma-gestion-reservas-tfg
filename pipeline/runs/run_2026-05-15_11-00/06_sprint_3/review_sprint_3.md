...
timestamp: 2026-05-15T11:22:22+02:00
...
|---|---:|---:|---:|---|
| `/` | `True` | `True` | `200` | http://127.0.0.1:58930/ |
| `/barcos/` | `True` | `True` | `200` | http://127.0.0.1:58930/barcos/ |
| `/cesta/` | `True` | `True` | `200` | http://127.0.0.1:58930/cesta/ |
| `/accounts/registro/` | `True` | `True` | `200` | http://127.0.0.1:58930/accounts/registro/ |
| `/accounts/login/` | `True` | `True` | `200` | http://127.0.0.1:58930/accounts/login/ |
...
| `admin_panel/boat_detail.html` | `True` | `True` |  |
| `admin_panel/boat_form.html` | `True` | `True` |  |
| `admin_panel/boats_list.html` | `True` | `True` |  |
| `admin_panel/client_detail.html` | `True` | `True` |  |
...
- `templates/admin_panel/boat_detail.html`
- `templates/admin_panel/boat_form.html`
- `templates/admin_panel/boats_list.html`
- `templates/admin_panel/client_detail.html`

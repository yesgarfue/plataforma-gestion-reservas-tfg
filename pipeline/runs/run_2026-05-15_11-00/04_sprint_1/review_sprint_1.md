...
timestamp: 2026-05-15T11:13:21+02:00
...
- Ruta /barcos/ no responde correctamente: .
...
|---|---:|---:|---:|---|
| `/` | `True` | `True` | `200` | http://127.0.0.1:51350/ |
| `/barcos/` | `True` | `False` | `404` |  |
| `/cesta/` | `True` | `False` | `404` |  |
| `/accounts/registro/` | `True` | `True` | `200` | http://127.0.0.1:51350/accounts/registro/ |
| `/accounts/login/` | `True` | `True` | `200` | http://127.0.0.1:51350/accounts/login/ |

...
timestamp: 2026-05-14T02:35:43+02:00
...
| RF-22 | Durante el proceso de reserva se solicitan los datos del cliente y los datos de pago, heredando los datos si hay sesión iniciada. | Alta |
...
| RF-29 | Una reserva puede cancelarse únicamente si está en estado PENDIENTE DE PAGO, implicando su eliminación del sistema sin quedar registrada con un estado posterior. | Alta |
...
| RF-37 | El administrador puede consultar y eliminar clientes desde el panel de administración, respetando la restricción de no eliminar clientes con reservas pendientes. | Alta |

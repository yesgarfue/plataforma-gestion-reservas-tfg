...
timestamp: 2026-05-14T16:53:33+02:00
...
| RF-11 | El filtro de fechas muestra todos los barcos del catálogo, marcando con etiqueta 'No disponible' los que no están disponibles en ese rango sin ocultarlos. | Alta |
| RF-12 | Los barcos agotados o no disponibles aparecen claramente marcados en el catálogo. | Alta |
| RF-13 | El cliente puede acceder a la ficha de un barco desde el catálogo, visualizando sus datos e imagen. | Alta |
...
| RF-29 | Si falta un día para el inicio de una reserva en estado PENDIENTE DE PAGO, el sistema envía un correo de recordatorio al usuario. | Alta |

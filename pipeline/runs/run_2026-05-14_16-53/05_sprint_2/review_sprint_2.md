...
timestamp: 2026-05-14T17:15:52+02:00
...
|---|---:|---:|---:|---|
| `/` | `True` | `True` | `200` | http://127.0.0.1:50090/ |
| `/barcos/` | `True` | `True` | `200` | http://127.0.0.1:50090/barcos/ |
| `/cesta/` | `True` | `False` | `404` |  |
| `/accounts/login/` | `True` | `True` | `200` | http://127.0.0.1:50090/accounts/login/ |

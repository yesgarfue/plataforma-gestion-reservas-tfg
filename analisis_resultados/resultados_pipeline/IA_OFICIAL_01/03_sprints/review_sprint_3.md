...
|---|---:|---:|---:|---|
| `/` | `True` | `True` | `200` | http://127.0.0.1:60020/ |
| `/barcos/` | `True` | `True` | `200` | http://127.0.0.1:60020/barcos/ |
| `/cesta/` | `True` | `True` | `200` | http://127.0.0.1:60020/cesta/ |
| `/accounts/login/` | `True` | `True` | `200` | http://127.0.0.1:60020/accounts/login/ |

...
timestamp: 2026-05-18T16:38:15+02:00
...
| RF-08 | El sistema permite buscar barcos por nombre o título desde la página de inicio. | Alta |
...
| RF-11 | El filtro de fechas muestra todos los barcos del catálogo, marcando con una etiqueta 'No disponible' aquellos no disponibles en ese rango sin ocultarlos. | Alta |
...
| RF-34 | El panel de administración permite la gestión de barcos: alta, edición y baja. | Alta |
| RF-35 | El panel de administración permite la gestión de clientes: consulta y eliminación con la restricción de no tener reservas pendientes. | Alta |
| RF-36 | El panel de administración permite la gestión de reservas: consulta y cambio de estado. | Alta |
...
| RNF-04 | Empaquetado | La aplicación se entrega como contenedor Docker con Dockerfile e instrucciones de construcción y arranque en README. | Alta |
...
| RNF-09 | Código Fuente | Los nombres de variables, clases, funciones y rutas están en inglés; comentarios y docstrings en español. | Media |

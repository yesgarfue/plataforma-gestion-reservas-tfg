...
Esta es una contraseña de aplicación de Google real (formato de 16 caracteres con espacios). Está expuesta en el repositorio. Cualquier persona con acceso al repo puede enviar emails desde `hundidosgestion@gmail.com`.
